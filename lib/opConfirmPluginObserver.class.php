 ...
 * @author     Yoshiyuki.tanaka <yoshiyuki.tanaka@kitsystem.co.jp>
 */
class opConfirmPluginObserver extends sfActions
{
  public function PostListener(sfEvent $event)
  {
    if(sfConfig::get('sf_app') == 'pc_frontend' && ($event['actionName'] != sfConfig::get('sf_login_action') || $event['moduleName'] != sfConfig::get('sf_login_module'))){
