...
$options->setDefault('isValid', false);
...
<?php if(!($error->getValidator() instanceof opValidatorConfirm)): ?>
<?php echo $error; ?>
<?php endif; ?>
<?php endforeach; ?>
<?php endforeach; ?>
...
<?php if ($hasRequiredField && !$options['isValid']): ?>
...
<?php if($options['isValid']): ?>
<input name="complete" type="submit" class="input_submit" value="<?php echo __('Complete'); ?>" />
<input name="modify" type="submit" class="input_submit" value="<?php echo __('Modify'); ?>" />
<?php else: ?>
